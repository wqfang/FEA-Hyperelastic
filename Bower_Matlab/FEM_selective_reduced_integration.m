...
%          Demonstrates use of selective reduced integration to fix
%          volumetric locking
%
...
%                            (assumed uniform) 
%
% This file should be run with the input file
% volumetric_locking_demo_linear.txt or volumetric_locking_demo_quad.txt
% 
%
...
outfile=fopen('Result_Reduced.txt','w');
...
%
 ...
 %
 % Compare the predicted deformation with the exact result
 %
 figure
            ...
            for k = 1:ndof
              ...
              for j = 1:ncoord
                for l = 1:ncoord
                  ...
                  kel(col,row) = kel(col,row) - ...
                      (1/ncoord)*dsde(j,j,k,l)*dNdx(b,l)*dNdx(a,i)*w(intpt)*dt;
                end
              end
            end
          end
...
%
%  Deviatoric part of stiffness is evaluated using reduced integration
%
